# Helmet + triple-riding zero-shot — §3.4 documented model (run 20260620-173710-a747)

- Stage-1: RF-DETR-nano @1280px (COCO-pretrained, Apache-2.0 — documented backbone §3.4)
...
|---|---|---|---|---|
| helmet violations | 11 | 11 | 1.0 | 2 |
| triple riding violations | 6 | 6 | 1.0 | 2 |
...
| Triple-riding proxy (≥3 riders) | 2/6 triggered |
